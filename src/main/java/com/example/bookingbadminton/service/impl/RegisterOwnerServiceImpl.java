...
public class RegisterOwnerServiceImpl implements RegisterOwnerService {
    ...
    public void delete(UUID id) {
        if (!registerOwnerRepository.existsById(id)) {
            throw new ResponseStatusException(HttpStatus.NOT_FOUND, "Register owner not found");
        }
        registerOwnerRepository.deleteById(id);
    }
}
